export const meta = {
  name: "glass-sidebar-20",
  description:
    "Phase 4e: Q1b related-active fix, then wave 3 (Q4, Q5, Q6); Codex gates and audit; no install.",
  phases: [
...
const waves = [["Q1b"], ["Q4", "Q5", "Q6"]];
let appendix = "### Q1, Q2, Q3 — RELEASED and integrated at aa6a2d4 (Q2 released by orchestrator override: integrated tip green, 33 files / 189 tests; commit-history purity not required). Anchors in src/ThreadList.tsx, src/RowContextMenu.tsx, app.tsx are live; Q3 owns the live strip and workflow rows.";
