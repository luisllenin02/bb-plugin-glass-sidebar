export const PROJECT_ICON_ROUTE =
  "/api/v1/plugins/glass-sidebar/http/project-icon";
...
// Ported from yusuf8834/bb-sidebar, itself mirroring T3 Code's useful,
// framework-agnostic candidates. Root icons win, then public/framework assets.
