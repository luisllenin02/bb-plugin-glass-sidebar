export const meta = {
  name: "glass-sidebar-22",
  description:
    "Phase 4f: Q5b auto-settle safety and Q3b session columns in parallel (disjoint files), then Q7 import command + switch-over runbook (no install); Codex gates and audit.",
  phases: [
...
const PACKETS = {
  ...
  Q5b: { id: "Q5b", title: "Auto-settle never settles live work", file: PLANS + "/packet-Q5b-lifecycle-safety.md", producer: "sol-xhigh" },
...
const waves = [["Q5b", "Q3b"], ["Q7"]];
let appendix = "### Q1, Q1b, Q2, Q3, Q4, Q6 — RELEASED and integrated; Q5 integrated at 0f0df4e but held on two auto-settle safety defects that Q5b fixes (Q2 by orchestrator override, tip green). Server bundle budget is now 1024 KB. (Q2 released by orchestrator override: integrated tip green, 33 files / 189 tests; commit-history purity not required). Anchors in src/ThreadList.tsx, src/RowContextMenu.tsx, app.tsx are live; Q3 owns the live strip and workflow rows.";
