...
- `dist/app.js` ≤ 300 KB, `dist/server.js` ≤ 1024 KB, no `setInterval` in
...
Wave order: wave 1 `Q1`; wave 2 `Q2, Q3`; wave 3 `Q4, Q5, Q6`; wave 4 `Q7`.
...
| Q2 | Organisation store, folders, menus, drag and drop | Q1 |
| Q3 | Live strip and workflow rows | Q1 |
| Q4 | Project decor absorbed: store, classifier, auto colour, picker, header chip | Q1, Q2 |
