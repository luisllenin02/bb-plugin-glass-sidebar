export const meta = {
  name: "glass-sidebar-17",
  description:
    "Phase 4c: port packets into the own glass-sidebar plugin in waves (args.waves, e.g. [[\"Q1\",\"Q2\",\"Q4\"],[\"Q3\",\"Q5\",\"Q6\"]]); Codex gates; Codex audit at the end; no install unless a packet says so.",
  phases: [
...
const waves = (args && Array.isArray(args.waves) && args.waves.length) ? args.waves : [["Q1"], ["Q2", "Q3"], ["Q4", "Q5", "Q6"]];
